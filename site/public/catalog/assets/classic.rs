//! `classic` — dotmax progress styles as a standalone, dependency-free program.
//!
...
//!
//! ```sh
//! rustc -O classic.rs && ./classic [style-name]
//! ```

const DEFAULT_STYLE: &str = "solid";
...
fn main() {
    ...
    let styles = progress::styles::classic::styles();
