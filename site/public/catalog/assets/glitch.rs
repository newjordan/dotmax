//! `glitch` — dotmax progress styles as a standalone, dependency-free program.
//!
...
//!
//! ```sh
//! rustc -O glitch.rs && ./glitch [style-name]
//! ```

const DEFAULT_STYLE: &str = "signal-restore";
...
fn main() {
    ...
    let styles = progress::styles::glitch::styles();
