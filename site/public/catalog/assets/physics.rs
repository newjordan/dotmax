//! `physics` — dotmax progress styles as a standalone, dependency-free program.
//!
...
//!
//! ```sh
//! rustc -O physics.rs && ./physics [style-name]
//! ```

const DEFAULT_STYLE: &str = "projectile";
...
fn main() {
    ...
    let styles = progress::styles::physics::styles();
