...
fn bench_detect_format_from_bytes(c: &mut Criterion) {
    ...
    // PNG magic bytes
    let png_bytes = [
        0x89u8, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ];

    // JPEG magic bytes
    let jpeg_bytes = [
        0xFFu8, 0xD8, 0xFF, 0xE0, 0x00, 0x10, 0x4A, 0x46, 0x49, 0x46, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x00,
    ];

    // GIF magic bytes
    let gif_bytes = [
        0x47u8, 0x49, 0x46, 0x38, 0x39, 0x61, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ];
